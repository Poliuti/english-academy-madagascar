  ...
  greetings: [
    {
      ...
      turns: [
        ...
        alternatives: ['Hi! My name is Paul.', 'Hello! I am Paul.', 'Hi! I am Paul.', 'Hello, my name is Paul.']
      } },
        ...
        alternatives: ['I come from Madagascar.']
      } },
        ...
        alternatives: ['I am fifteen years old.', 'I am 15.', 'I am fifteen.']
      } },
  ...
  market: [
    {
      ...
      turns: [
        ...
        alternatives: ['Yes, I want some bananas, please.', 'Yes, bananas please.', 'I would like bananas please.']
      } },
        ...
        alternatives: ['Five bananas.', 'Five.', 'I want five.', 'Give me five, please.']
      } },
  ...
  directions: [
    {
      ...
      turns: [
        ...
        alternatives: ['Go straight, then turn left.', 'Go straight and then turn left.', 'Go straight ahead and turn left.']
      } },
        ...
        alternatives: ['Not at all.', 'No problem.', 'My pleasure.', 'No worries.']
      } },
      ]
    }
  ],
  ...
  restaurant: [
    {
      ...
      turns: [
        ...
        alternatives: ['Yes, I want chicken and rice, please.', 'Chicken and rice, please.']
      } },
        ...
        alternatives: ['Water, please.', 'Could I have a glass of water, please?']
      } },
        ...
        alternatives: ['Can I get the bill, please?', 'Could I have the bill?', 'The bill please.', 'Check, please.']
      } },
      ]
    }
  ],
  ...
  doctor: [
    {
      ...
      turns: [
        ...
        alternatives: ['I have a headache and fever.', 'I have a headache. I also have a fever.']
      } },
        ...
        alternatives: ['Yesterday.', 'Since last night.', 'Since yesterday morning.', 'Since yesterday evening.', 'For one day.']
      } },
        ...
        alternatives: ['Thanks, doctor.', 'Thank you very much.', 'Thank you.', 'Thanks.']
      } },
      ]
    }
  ],
  ...
  phone: [
    {
      ...
      turns: [
        ...
        alternatives: ['She is not here.', 'She is out right now.', 'She is not here at the moment.']
      } },
        ...
        alternatives: ['I will tell her, goodbye.', 'I will let her know. Goodbye.', 'OK, I will tell her. Bye.']
      } },
      ]
    }
  ],
  ...
  interview: [
    {
      ...
      turns: [
        ...
        alternatives: ['My name is Paul and I come from Madagascar.', 'I am Paul and I come from Madagascar.', 'My name is Paul. I come from Madagascar.', 'My name is Paul, I come from Madagascar.', 'I am Paul and I am from Madagascar.']
      } },
        ...
        alternatives: ['I would like to learn new things.', 'I want to learn new skills.', 'I want to discover new things.']
      } },
        ...
        alternatives: ['Yes, I speak English.', 'Yes, I can speak English.']
      } },
      ]
    }
  ],
  ecole: [
    {
      ...
      turns: [
        ...
        alternatives: ['Good morning!', 'Good morning, sir.', 'Good morning, miss.', 'Morning, teacher.']
      } },
        ...
        alternatives: ['Yes, I will.', 'Yes. Thank you.', 'OK, I will. Thank you.', 'Yes, I will bring it. Thank you.']
      } },
        ...
        alternatives: ['I like English.', 'English is my favourite subject.', 'English is my favorite subject.', 'My favorite subject is English.', 'I love English.', 'English.']
      } },
      ]
    }
  ],
  ...
  sport: [
    {
      ...
      turns: [
        ...
        alternatives: ['Yes, I like football.', 'Yes, I love soccer.', 'Yes, I enjoy football.', 'Football, yes!']
      } },
        ...
        alternatives: ['Twice a week.', 'Two times a week.', 'I play two times a week.', 'I play football twice a week.']
      } },
        ...
        alternatives: ['I prefer swimming.', 'Swimming. It is relaxing.', 'I like swimming.']
      } },
      ]
    }
  ],
  ...
  famille: [
    {
      ...
      turns: [
        ...
        alternatives: ['My family is small.', 'We are a small family.']
      } },
        ...
        alternatives: ['One brother and two sisters.']
      } },
        ...
        alternatives: ['No, they live in a village.', 'No. They live in the village.', 'No, they live in their village.']
      } },
      ]
    }
  ],
  ...
  shopping: [
    {
      ...
      turns: [
        ...
        alternatives: ['Yes, I need a tee-shirt.', 'I am looking for a tee-shirt.', 'Yes, a tee-shirt please.']
      } },
        ...
        alternatives: ['Blue or black, please.', 'I like blue or black.', 'Blue or black.']
      } },
        ...
        alternatives: ['OK, I will take it.', 'I will take it.']
      } },
      ]
    }
  ],
  ...
  weekend: [
    {
      ...
      turns: [
        ...
        alternatives: ['I visited the beach with my family.', 'I went to the beach.', 'We went to the beach.']
      } },
        ...
        alternatives: ['I will see my grandparents.', 'I am going to visit my grandparents.']
      } },
        ...
        alternatives: ['Thank you! Same to you!', 'Thank you. You too.', 'Thank you, same to you!']
      } },
      ]
    }
  ],
