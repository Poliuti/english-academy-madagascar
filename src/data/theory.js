  ...
  vocabulary: {
    routine: {
      ...
      words: [
        ...
        { en: 'take a shower', fr: 'prendre une douche', mg: 'manasa vatana [À VÉRIFIER]', example: 'I take a shower every morning.' },
        { en: 'have breakfast', fr: 'prendre le petit-déjeuner', mg: 'misakafo maraina', example: 'We have breakfast at 7:30.' },
        { en: 'go to school', fr: 'aller à l\'école', mg: 'mankany sekoly [À VÉRIFIER]', example: 'The children go to school at 8.' },
        { en: 'have lunch', fr: 'déjeuner', mg: 'misakafo atoandro [À VÉRIFIER]', example: 'We have lunch at noon.' },
        ...
        { en: 'go to bed', fr: 'se coucher', mg: 'matory [À VÉRIFIER]', example: 'I go to bed at 10 pm.' },
        { en: 'brush teeth', fr: 'se brosser les dents', mg: 'manasa nify [À VÉRIFIER]', example: 'Brush your teeth twice a day!' },
      ]
    },
    family: {
      ...
      words: [
        ...
        { en: 'cousin', fr: 'cousin(e)', mg: 'zanak\'olo-mpiray tam-po [À VÉRIFIER]', example: 'I play with my cousins on weekends.' },
    ...
    body: {
      ...
      words: [
        ...
        { en: 'leg', fr: 'jambe', mg: 'ranjo [À VÉRIFIER]', example: 'She hurt her leg.' },
...

  {
    ...
    rows: [
      ...
      },
      {
        ...
        example_mg: 'Nankany an\'ny sekoly izy. / Nihinam-bary aho. [À VÉRIFIER]',
      ...
      },
      {
        ...
        example_mg: 'Tsy nankany an\'ny sekoly aho. [À VÉRIFIER]',
...

  {
    ...
    rows: [
      ...
      },
      {
        ...
        example_mg: 'Ahoana ny valinao? / Tsara ve ianao? [À VÉRIFIER]',
...

  {
    ...
    rows: [
      ...
      },
      {
        ...
        example_mg: 'Hatriniry no nianarànao anglisy? [À VÉRIFIER]',
    ...
    rows: [
      {
        ...
        example_mg: 'Tia mamaky aho. / Menatra mitaingina fiara izy. [À VÉRIFIER]',
...

  {
    ...
    rows: [
      ...
      },
      {
        ...
        example_mg: 'Ny mpianatra izay nangalarina ny entany... [À VÉRIFIER]',
