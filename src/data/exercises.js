...
exercises.pastPerfect.push(
  ...
  {id:'ppt_2_03',type:'translate',diffLevel:2,instruction:'Traduisez en anglais.',french:'Ils avaient fini leur travail avant la réunion.',answer:'They had finished their work before the meeting.',hint:'ils avaient fini → they had finished',explanation:'"Had finished before the meeting."', acceptedAnswers: ['They had completed their work before the meeting.'] },
...
exercises.conditionals.push(
  ...
  // Level 2 (+15)
  {id:'cond_2_01',type:'translate',diffLevel:2,instruction:'Traduisez en anglais.',french:"Si tu étudies, tu réussiras l'examen.",answer:'If you study, you will pass the exam.',hint:'Conditionnel.',explanation:'Conditionnel 1.'},
  {id:'cond_2_02',type:'translate',diffLevel:2,instruction:'Traduisez en anglais.',french:"Si j'étais riche, j'achèterais une maison.",answer:'If I were rich, I would buy a house.',hint:'Conditionnel.',explanation:'Conditionnel 2 — hypothèse irréelle.'},
  ...
  {id:'cond_2_05',type:'translate',diffLevel:2,instruction:'Traduisez en anglais.',french:"Si nous partions maintenant, nous arriverions à l'heure.",answer:'If we left now, we would arrive on time.',alternatives:['If we left now, we would be on time.'],hint:'Conditionnel.',explanation:'Conditionnel 2.'},
...
exercises.passiveVoice.push(
  ...
  // Level 2 (+15)
  {id:'pv_2_01',type:'translate',diffLevel:2,instruction:'Traduisez en anglais.',french:'La voiture a été volée hier soir.',answer:'The car was stolen last night.',hint:'a été volée → was stolen',explanation:'Passif passé.', acceptedAnswers: ['Last night, the car was stolen.'] },
  {id:'pv_2_02',type:'translate',diffLevel:2,instruction:'Traduisez en anglais.',french:'Le riz est cultivé dans de nombreux pays.',answer:'Rice is grown in many countries.',hint:'est cultivé → is grown',explanation:'Passif présent.', acceptedAnswers: ['Rice is cultivated in many countries.', 'Rice is produced in many countries.'] },
  ...
  {id:'pv_2_04',type:'translate',diffLevel:2,instruction:'Traduisez en anglais.',french:"L'école sera construite l'année prochaine.",answer:'The school will be built next year.',hint:'sera construite → will be built',explanation:'Passif futur : will be + participe.', acceptedAnswers: ['The school is going to be built next year.'] },
...
exercises.reportedSpeech.push(
  ...
  // Level 2 (+15)
  {id:'rs_2_01',type:'translate',diffLevel:2,instruction:'Traduisez en anglais.',french:'"Je suis fatigué," dit-il.',answer:'He said he was tired.',alternatives:['He said that he was tired.'],hint:'Discours indirect : verbe introducteur + proposition.',explanation:'Am → was (backshifting).'},
  {id:'rs_2_02',type:'translate',diffLevel:2,instruction:'Traduisez en anglais.',french:'"J\'irai à Paris," dit-elle.',answer:'She said she would go to Paris.',alternatives:['She said that she would go to Paris.'],hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"Will go" → "would go".'},
  {id:'rs_2_03',type:'translate',diffLevel:2,instruction:'Traduisez en anglais.',french:'"Je peux nager," dit-il.',answer:'He said he could swim.',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"Can swim" → "could swim".', acceptedAnswers: ['He said that he could swim.'] },
...
exercises.futureContinuous.push(
  ...
  {id:'fc_2_04',type:'translate',diffLevel:2,instruction:'Traduisez en anglais.',french:'Elle dormira quand tu arriveras.',answer:'She will be sleeping when you arrive.',hint:'elle dormira = she will be sleeping',explanation:'"Will be sleeping when you arrive."', acceptedAnswers: ['She will be asleep when you arrive.'] },
...
exercises.futurePerfect.push(
  ...
  // Level 2 (+15)
  {id:'fp_2_01',type:'translate',diffLevel:2,instruction:'Traduisez en anglais.',french:"D'ici la fin du mois, j'aurai fini le projet.",answer:'By the end of the month, I will have finished the project.',hint:'j\'aurai fini → I will have finished',explanation:'"Will have finished" — futur antérieur.', acceptedAnswers: ['By the end of the month, I will have completed the project.'] },
  ...
  {id:'fp_2_03',type:'translate',diffLevel:2,instruction:'Traduisez en anglais.',french:"D'ici 2030, les scientifiques auront trouvé de nouveaux remèdes.",answer:'By 2030, scientists will have found new cures.',hint:'auront trouvé → will have found',explanation:'"Will have found by 2030."', acceptedAnswers: ['By 2030, scientists will have discovered new cures.', 'By 2030, scientists will have found new remedies.'] },
  ...
  {id:'fp_2_05',type:'translate',diffLevel:2,instruction:'Traduisez en anglais.',french:"Il travaillera ici depuis 10 ans en décembre.",answer:'By December, he will have worked here for ten years.',hint:'il aura travaillé → will have worked',explanation:'"Will have worked for ten years."', acceptedAnswers: ['By December, he will have been working here for ten years.'] },
...
exercises.goingTo = [
  ...
  {id:'gt_2_01',type:'translate',diffLevel:2,
   ...
   acceptedAnswers: ['She', 'She will start a new job next week.'],
  ...
  {id:'gt_2_07',type:'translate',diffLevel:2,
   ...
   acceptedAnswers: ['We', 'We will try this new restaurant tonight.'],
