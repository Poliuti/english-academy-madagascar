...
export const exercises = {
  ...
  {id:'r_sw_05',type:'fill-blank',diffLevel:1,instruction:'Completez avec la bonne forme du verbe.',template:'They ___ breakfast every morning.',answer:'eat',hint:'Accord du verbe avec le sujet.',explanation:'They eat breakfast.'},
  {id:'r_sw_06',type:'fill-blank',diffLevel:1,instruction:'Completez avec la bonne forme du verbe.',template:'He ___ at 10pm every night.',answer:'sleeps',hint:'Accord du verbe avec le sujet.',explanation:'He sleeps at 10pm.'},
    ...
    { id: "r17", type: "fill-blank", diffLevel: 1, level: "A1", instruction: "Complétez avec le mot correct.", template: "We ___ home at five.", answer: "come", hint: "Cherche le mot de vocabulaire qui convient.", explanation: "Avec 'we', verbe sans -s." },
    ...
    { id: "r20", type: "fill-blank", diffLevel: 1, level: "A1", instruction: "Complétez avec le mot correct.", template: "They ___ dinner at seven.", answer: "have", hint: "Cherche le mot de vocabulaire qui convient.", explanation: "'They' → pas de -s." },
  ...
  {id:'ta_sw_02',type:'fill-blank',diffLevel:1,instruction:'Completez avec le bon adverbe.',template:'He ___ comes late. Maybe once a year.',answer:'rarely',hint:'Adverbe de fréquence : pense au sens (jamais ↔ toujours).',alternatives:['seldom','never'],explanation:'He rarely comes late.'},
...
exercises.prepositions.push(
  ...
  {id:'prep_1_11',type:'fill-blank',diffLevel:1,instruction:'Complétez avec in, on ou at.',template:'The shop is ___ the corner.',answer:'on',hint:'Quelle préposition de lieu/temps ?',explanation:'"On the corner" — expression fixe.'},
...
exercises.modals.push(
  ...
  {id:'mod_1_08',type:'fill-blank',diffLevel:1,instruction:"Complétez avec should ou shouldn't.",template:'You ___ stay up too late. You have school tomorrow.',answer:"shouldn't",hint:'mauvais conseil.',explanation:'"Shouldn\'t" = ne devrait pas (conseil négatif).'},
  {id:'mod_1_09',type:'fill-blank',diffLevel:1,instruction:"Complétez avec must ou mustn't.",template:'You ___ touch that wire — it is dangerous.',answer:"mustn't",hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"Mustn\'t" = interdiction absolue (danger).'},
  {id:'mod_1_10',type:'fill-blank',diffLevel:1,instruction:"Complétez avec will ou would.",template:'___ you like some tea?',answer:'Would',hint:'offre polie.',explanation:'"Would you like...?" = offre polie.'},
  {id:'mod_1_11',type:'fill-blank',diffLevel:1,instruction:"Complétez avec may ou might.",template:'She ___ be at the market — I\'m not sure.',answer:'might',alternatives:['may'],hint:'Quel modal exprime le sens voulu ?',explanation:'"Might/may" = peut-être.'},
...
exercises.presentPerfect.push(
  ...
  {id:'pp_1_07',type:'fill-blank',diffLevel:1,instruction:'Complétez avec have/has.',template:'I ___ known him since 2010.',answer:'have',hint:'Accord sujet–verbe.',explanation:'"I have known him since 2010."'},
  {id:'pp_1_08',type:'fill-blank',diffLevel:1,instruction:'Complétez avec have/has.',template:'She ___ never tried sushi.',answer:'has',hint:'Accord sujet–verbe.',explanation:'"She has never tried sushi."'},
  {id:'pp_1_09',type:'fill-blank',diffLevel:1,instruction:'Complétez avec have/has.',template:'They ___ just left the office.',answer:'have',hint:'Accord sujet–verbe.',explanation:'"They have just left."'},
  {id:'pp_1_10',type:'fill-blank',diffLevel:1,instruction:'Complétez avec have/has.',template:'He ___ already done his homework.',answer:'has',hint:'Accord sujet–verbe.',explanation:'"He has already done."'},
  {id:'pp_1_11',type:'fill-blank',diffLevel:1,instruction:'Complétez avec have/has.',template:'We ___ lived here for five years.',answer:'have',hint:'Accord sujet–verbe.',explanation:'"We have lived here for five years."'},
...
exercises.timeMarkers.push(
  ...
  {id:'tm_1_07',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon marqueur.',template:'I have ___ arrived — I am at the door.',answer:'just',hint:'vient de se passer.',explanation:'"Just" = vient de (action très récente).'},
  {id:'tm_1_08',type:'fill-blank',diffLevel:1,instruction:'Complétez avec yet ou already.',template:'Have you finished ___?',answer:'yet',hint:'Forme interrogative.',explanation:'"Yet" dans les questions = déjà?'},
  {id:'tm_1_09',type:'fill-blank',diffLevel:1,instruction:'Complétez avec still ou yet.',template:'She ___ studies every night.',answer:'still',hint:'habitude continue.',explanation:'"Still" = toujours, continue à.'},
  {id:'tm_1_10',type:'fill-blank',diffLevel:1,instruction:'Complétez avec ago ou since.',template:'He left ten minutes ___.',answer:'ago',hint:'Quel marqueur de temps convient ?',explanation:'"Ten minutes ago" = il y a dix minutes.'},
  {id:'tm_1_11',type:'fill-blank',diffLevel:1,instruction:'Complétez avec for ou since.',template:'They have known each other ___ 2015.',answer:'since',hint:'point de départ.',explanation:'"Since 2015" = depuis 2015 (point précis).'},
...
exercises.conditionals.push(
  ...
  {id:'cond_1_07',type:'fill-blank',diffLevel:1,instruction:'Complétez la phrase.',template:'If you study, you ___ pass the exam.',answer:'will',hint:'Conditionnel.',explanation:'"Will pass" — condition réalisable.'},
  {id:'cond_1_08',type:'fill-blank',diffLevel:1,instruction:'Complétez la phrase.',template:'If I ___ a bird, I would fly.',answer:'were',hint:'Conditionnel type 2 : forme du verbe "être".',explanation:'"If I were" — subjonctif conditionnel 2.'},
  {id:'cond_1_09',type:'fill-blank',diffLevel:1,instruction:'Complétez la phrase.',template:'If it snows, the school ___ close.',answer:'will',hint:'Conditionnel.',explanation:'"Will close" — conditionnel 1.'},
  {id:'cond_1_10',type:'fill-blank',diffLevel:1,instruction:'Complétez la phrase.',template:'If he had called, I ___ answered.',answer:'would have',hint:'Past simple.',explanation:'"Would have answered" — conditionnel 3.'},
  {id:'cond_1_11',type:'fill-blank',diffLevel:1,instruction:'Complétez la phrase.',template:'She ___ help if she could.',answer:'would',hint:'Conditionnel.',explanation:'"Would help" — conditionnel 2.'},
...
exercises.passiveVoice.push(
  ...
  {id:'pv_1_07',type:'fill-blank',diffLevel:1,instruction:'Complétez avec is/are/was/were.',template:'Rice ___ grown in Madagascar.',answer:'is',hint:'présent singulier.',explanation:'"Rice is grown" — passif présent.'},
  {id:'pv_1_08',type:'fill-blank',diffLevel:1,instruction:'Complétez avec is/are/was/were.',template:'Many trees ___ cut down every year.',answer:'are',hint:'trees = pluriel.',explanation:'"Trees are cut down" — passif pluriel.'},
  {id:'pv_1_09',type:'fill-blank',diffLevel:1,instruction:'Complétez avec is/are/was/were.',template:'The bridge ___ built in 1900.',answer:'was',hint:'Past simple.',explanation:'"Was built" — passé passif.'},
  {id:'pv_1_10',type:'fill-blank',diffLevel:1,instruction:'Complétez avec is/are/was/were.',template:'The film ___ directed by Spielberg.',answer:'was',hint:'Past simple.',explanation:'"Was directed" — passif passé.'},
  {id:'pv_1_11',type:'fill-blank',diffLevel:1,instruction:'Complétez avec is/are/was/were.',template:'These shoes ___ made in Italy.',answer:'are',hint:'shoes = pluriel.',explanation:'"Shoes are made" — passif présent pluriel.'},
...
exercises.reportedSpeech.push(
  ...
  {id:'rs_1_07',type:'fill-blank',diffLevel:1,instruction:'Transformez au discours indirect.',template:'"I am happy." → She said she ___ happy.',answer:'was',hint:'am.',explanation:'"Am" → "was" (backshifting).'},
  {id:'rs_1_08',type:'fill-blank',diffLevel:1,instruction:'Transformez au discours indirect.',template:'"I will call you." → He said he ___ call me.',answer:'would',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"Will" → "would".'},
  {id:'rs_1_09',type:'fill-blank',diffLevel:1,instruction:'Transformez au discours indirect.',template:'"I can drive." → She said she ___ drive.',answer:'could',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"Can" → "could".'},
  ...
  {id:'rs_1_11',type:'fill-blank',diffLevel:1,instruction:'Transformez au discours indirect.',template:'"I like music." → She said she ___ music.',answer:'liked',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"Like" → "liked".'},
...
exercises.comparatives.push(
  ...
  {id:'comp_1_08',type:'fill-blank',diffLevel:1,instruction:'Complétez avec la forme correcte.',template:'January is ___ month of the year. (cold)',answer:'the coldest',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"The coldest month."'},
  {id:'comp_1_09',type:'fill-blank',diffLevel:1,instruction:'Complétez avec la forme correcte.',template:'He is ___ than his brother. (tall)',answer:'taller',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"Taller" — adj court.'},
  {id:'comp_1_10',type:'fill-blank',diffLevel:1,instruction:'Complétez avec la forme correcte.',template:'She is ___ student in the school. (good)',answer:'the best',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"The best" — superlatif irrégulier.'},
  {id:'comp_1_11',type:'fill-blank',diffLevel:1,instruction:'Complétez avec la forme correcte.',template:'Today is ___ than yesterday. (hot)',answer:'hotter',hint:'Pense à la forme du comparatif/superlatif.',explanation:'"Hotter" — consonne finale doublée.'},
...
exercises.interrogative.push(
  ...
  {id:'int_1_07',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon mot interrogatif.',template:'___ did you go last weekend?',answer:'Where',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"Where did you go?"'},
  {id:'int_1_08',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon mot interrogatif.',template:'___ is the meeting?',answer:'When',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"When is the meeting?"'},
  {id:'int_1_09',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon mot interrogatif.',template:'___ long have you been learning English?',answer:'How',hint:'Quel mot interrogatif convient ?',explanation:'"How long" = depuis combien de temps.'},
  {id:'int_1_10',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon mot interrogatif.',template:'___ do you prefer: tea or coffee?',answer:'Which',hint:'choix entre options.',explanation:'"Which" = lequel (choix limité).'},
  {id:'int_1_11',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon mot interrogatif.',template:'___ are you crying?',answer:'Why',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"Why are you crying?"'},
...
exercises.imperatives.push(
  ...
  {id:'imp_1_07',type:'fill-blank',diffLevel:1,instruction:"Complétez avec l'impératif.",template:'___ your homework before playing!',answer:'Do',hint:'Impératif (forme de base du verbe).',explanation:'"Do your homework!"'},
  {id:'imp_1_08',type:'fill-blank',diffLevel:1,instruction:"Complétez avec l'impératif.",template:'___ run in the corridors.',answer:"Don't",hint:"défense.",explanation:'"Don\'t run" — interdit.'},
  ...
  {id:'imp_1_10',type:'fill-blank',diffLevel:1,instruction:"Complétez avec l'impératif.",template:'___ careful on the road.',answer:'Be',hint:'Impératif du verbe "être".',explanation:'"Be careful."'},
  {id:'imp_1_11',type:'fill-blank',diffLevel:1,instruction:"Complétez avec l'impératif.",template:'___ late to class.',answer:"Don't be",hint:"Impératif négatif du verbe \"être\".",explanation:'"Don\'t be late."'},
...
exercises.someAny.push(
  ...
  {id:'sa_1_07',type:'fill-blank',diffLevel:1,instruction:'Complétez avec some ou any.',template:'She bought ___ bread at the market.',answer:'some',hint:'Forme affirmative.',explanation:'"Some bread" — affirmatif.'},
  {id:'sa_1_08',type:'fill-blank',diffLevel:1,instruction:'Complétez avec some ou any.',template:'Are there ___ students in the classroom?',answer:'any',hint:'Forme interrogative.',explanation:'"Any students" — question.'},
  {id:'sa_1_09',type:'fill-blank',diffLevel:1,instruction:'Complétez avec some ou any.',template:"He didn't eat ___ vegetables.",answer:'any',hint:"Forme négative.",explanation:'"Any vegetables" — négatif.'},
  {id:'sa_1_10',type:'fill-blank',diffLevel:1,instruction:'Complétez avec some/someone/something.',template:'___ has left a message for you.',answer:'Someone',hint:'personne inconnue.',explanation:'"Someone" = quelqu\'un (affirmatif).'},
  {id:'sa_1_11',type:'fill-blank',diffLevel:1,instruction:'Complétez avec some ou any.',template:"I don't have ___ information.",answer:'any',hint:"Forme négative.",explanation:'"Any information" — négatif.'},
...
exercises.irregularVerbs.push(
  ...
  {id:'irv_1_07',type:'fill-blank',diffLevel:1,instruction:'Donnez la forme correcte du verbe.',template:'She ___ the book in one day. (read)',answer:'read',hint:'Forme du passé du verbe.',explanation:'"Read" (passé) = même orthographe, prononcé /rɛd/.'},
  {id:'irv_1_08',type:'fill-blank',diffLevel:1,instruction:'Donnez la forme correcte du verbe.',template:'They ___ a new house last year. (buy)',answer:'bought',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"Bought" = passé de "buy".'},
  {id:'irv_1_09',type:'fill-blank',diffLevel:1,instruction:'Donnez la forme correcte du verbe.',template:'He ___ me a beautiful letter. (write)',answer:'wrote',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"Wrote" = passé de "write".'},
  {id:'irv_1_10',type:'fill-blank',diffLevel:1,instruction:'Donnez la forme correcte du verbe.',template:'I have ___ that film twice. (see)',answer:'seen',hint:'Participe passé du verbe.',explanation:'"Seen" = participe de "see".'},
  {id:'irv_1_11',type:'fill-blank',diffLevel:1,instruction:'Donnez la forme correcte du verbe.',template:'We ___ to the beach last summer. (go)',answer:'went',hint:'Forme du passé du verbe.',explanation:'"Went" = passé de "go".'},
...
exercises.possessives.push(
  ...
  {id:'pos_1_07',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon possessif.',template:'This is ___ pen — please give it back. (I own it)',answer:'my',hint:'adjectif possessif.',explanation:'"My pen."'},
  {id:'pos_1_08',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon possessif.',template:'Is that ___ car? (you)',answer:'your',hint:'adjectif possessif.',explanation:'"Your car."'},
  {id:'pos_1_09',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon possessif.',template:'The dog wagged ___ tail.',answer:'its',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"Its tail" — possessif neutre.'},
  {id:'pos_1_10',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon possessif.',template:'We gave ___ teacher a gift.',answer:'our',hint:'Accord sujet–verbe.',explanation:'"Our teacher."'},
  {id:'pos_1_11',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon possessif.',template:'That bag is ___. (she owns it)',answer:'hers',hint:'pronom possessif.',explanation:'"That bag is hers."'},
...
exercises.adverbs.push(
  ...
  {id:'adv_1_08',type:'fill-blank',diffLevel:1,instruction:'Complétez avec l\'adverbe de fréquence.',template:'I am ___ late — hurry up! (already)',answer:'already',hint:'Quel marqueur de temps convient ?',explanation:'"Already late."'},
...
exercises.countableUncountable.push(
  ...
  {id:'cu_1_07',type:'fill-blank',diffLevel:1,instruction:'Complétez avec much, many, a little ou a few.',template:'I need ___ help with this.',answer:'a little',hint:'help = non-dénombrable.',explanation:'"A little help" — non-dénombrable.'},
  {id:'cu_1_08',type:'fill-blank',diffLevel:1,instruction:'Complétez avec much, many, a little ou a few.',template:'How ___ students are in the class?',answer:'many',hint:'students = dénombrable.',explanation:'"How many students."'},
  {id:'cu_1_09',type:'fill-blank',diffLevel:1,instruction:'Complétez avec much, many, a little ou a few.',template:'How ___ sugar do you take?',answer:'much',hint:'sugar = non-dénombrable.',explanation:'"How much sugar."'},
  {id:'cu_1_10',type:'fill-blank',diffLevel:1,instruction:'Complétez avec much, many, a little ou a few.',template:'There are only ___ apples left.',answer:'a few',hint:'apples = dénombrable.',explanation:'"A few apples" — quelques.'},
  {id:'cu_1_11',type:'fill-blank',diffLevel:1,instruction:'Complétez avec much, many, a little ou a few.',template:'She has ___ patience with difficult students.',answer:'little',hint:'patience = non-dénombrable.',explanation:'"Little patience" — peu de patience.'},
...
exercises.connectors.push(
  ...
  {id:'con_1_07',type:'fill-blank',diffLevel:1,instruction:'Choisissez le bon connecteur.',template:'She studied hard ___ she failed the exam.',answer:'but',hint:'contraste inattendu.',explanation:'"But" — contraste.'},
  {id:'con_1_08',type:'fill-blank',diffLevel:1,instruction:'Choisissez le bon connecteur.',template:'He was late ___ the traffic was bad.',answer:'because',hint:'Conjonction de cause.',explanation:'"Because" — cause.'},
  {id:'con_1_09',type:'fill-blank',diffLevel:1,instruction:'Choisissez le bon connecteur.',template:'It was cold; ___, we enjoyed our walk.',answer:'however',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"However" — contraste formel.'},
  {id:'con_1_10',type:'fill-blank',diffLevel:1,instruction:'Choisissez le bon connecteur.',template:'She was tired, ___ she finished the work.',answer:'but',hint:'malgré la fatigue.',explanation:'"But" — contraste.'},
  {id:'con_1_11',type:'fill-blank',diffLevel:1,instruction:'Choisissez le bon connecteur.',template:"I'll help ___ you ask politely.",answer:'if',hint:'Conditionnel.',explanation:'"If" — condition.'},
...
exercises.phrasalVerbs.push(
  ...
  {id:'phv_1_07',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon phrasal verb.',template:'She ___ smoking because of her health.',answer:'gave up',hint:'arrêter.',explanation:'"Gave up smoking."'},
  {id:'phv_1_08',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon phrasal verb.',template:'Please ___ the lights when you leave.',answer:'turn off',hint:'éteindre.',explanation:'"Turn off the lights."'},
  ...
  {id:'phv_1_10',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon phrasal verb.',template:'The meeting has been ___ until next week.',answer:'put off',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"Put off" = reporter.'},
  {id:'phv_1_11',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon phrasal verb.',template:'I need to ___ when the train arrives.',answer:'find out',hint:'découvrir.',explanation:'"Find out" = se renseigner.'},
...
exercises.pastSimple.push(
  ...
  {id:'pts_1_07',type:'fill-blank',diffLevel:1,instruction:'Complétez au past simple.',template:'She ___ a letter yesterday. (write)',answer:'wrote',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"Wrote" — irrégulier.'},
  {id:'pts_1_08',type:'fill-blank',diffLevel:1,instruction:'Complétez au past simple.',template:'We ___ football last Sunday. (play)',answer:'played',hint:'Forme du passé du verbe.',explanation:'"Played" — régulier.'},
  {id:'pts_1_09',type:'fill-blank',diffLevel:1,instruction:'Complétez au past simple.',template:'He ___ not finish his homework.',answer:"didn't",hint:'Forme négative.',explanation:'"Didn\'t finish."'},
  {id:'pts_1_10',type:'fill-blank',diffLevel:1,instruction:'Complétez au past simple.',template:'They ___ at home last night.',answer:'were',hint:'Past simple de "be".',explanation:'"They were at home."'},
  {id:'pts_1_11',type:'fill-blank',diffLevel:1,instruction:'Complétez au past simple.',template:'I ___ her at the market. (see)',answer:'saw',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"Saw" — irrégulier.'},
...
exercises.pronouns.push(
  ...
  {id:'prn_1_05',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon pronom.',template:'She loves the music — ___ is so beautiful.',answer:'it',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"It" — neutre singulier.'},
  {id:'prn_1_06',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon pronom.',template:'We helped ___. (the children)',answer:'them',hint:'children = pluriel.',explanation:'"Them" — pronom objet pluriel.'},
  {id:'prn_1_07',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon pronom réfléchi.',template:'He cut ___.',answer:'himself',hint:'Accord sujet–verbe.',explanation:'"Himself" — pronom réfléchi masculin.'},
  {id:'prn_1_08',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon pronom.',template:'Please give ___ the book.',answer:'me',hint:'indirect object.',explanation:'"Give me the book."'},
  {id:'prn_1_09',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon pronom réfléchi.',template:'She taught ___ to swim.',answer:'herself',hint:'Accord sujet–verbe.',explanation:'"Herself" — pronom réfléchi féminin.'},
  {id:'prn_1_10',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon pronom.',template:'I met ___ yesterday. (your friend)',answer:'him',alternatives:['her'],hint:'Quel pronom (sujet/complément) convient ?',explanation:'"Him/her" — pronom objet.'},
  {id:'prn_1_11',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon pronom.',template:'The dog hurt ___.',answer:'itself',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"Itself" — neutre réfléchi.'},
...
exercises.futureSimple.push(
  ...
  {id:'fts_1_07',type:'fill-blank',diffLevel:1,instruction:'Complétez avec will.',template:'I ___ help you with that.',answer:'will',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"I will help you."'},
  {id:'fts_1_08',type:'fill-blank',diffLevel:1,instruction:'Complétez avec will.',template:'She ___ come if she can.',answer:'will',hint:'Conditionnel.',explanation:'"She will come."'},
  {id:'fts_1_09',type:'fill-blank',diffLevel:1,instruction:'Complétez avec will.',template:'It ___ probably be cold tonight.',answer:'will',hint:'Futur (prédiction).',explanation:'"Will probably be cold."'},
  {id:'fts_1_10',type:'fill-blank',diffLevel:1,instruction:'Complétez avec will.',template:'___ he be at the meeting?',answer:'Will',hint:'Quel auxiliaire pour le futur ?',explanation:'"Will he be at the meeting?"'},
  {id:'fts_1_11',type:'fill-blank',diffLevel:1,instruction:'Complétez avec will.',template:'They ___ not finish in time.',answer:'will',hint:'Quel auxiliaire pour le futur ?',explanation:'"They will not finish."'},
...
exercises.conditionals.push(
  // __ L1 audit additions __
  {id:'cond_sw_01',type:'fill-blank',diffLevel:1,instruction:'Completez avec la bonne forme.',template:'If it rains, I ___ my umbrella.',answer:'will',hint:'Conditionnel type 1 : auxiliaire de la principale.',explanation:'I will take my umbrella.'},
  {id:'cond_sw_02',type:'fill-blank',diffLevel:1,instruction:'Completez avec la bonne forme.',template:'If she studies, she ___ the exam.',answer:'will',hint:'Conditionnel type 1 : auxiliaire de la principale.',explanation:'She will pass the exam.'},
  {id:'cond_sw_03',type:'fill-blank',diffLevel:1,instruction:'Completez avec la bonne forme.',template:'If I had money, I ___ a car.',answer:'would',hint:'Conditionnel type 2 : auxiliaire de la principale.',explanation:'I would buy a car.'},
  ...
  {id:'cond_sw_06',type:'fill-blank',diffLevel:1,instruction:'Completez avec la bonne forme.',template:'If she ___ early, she will catch the bus.',answer:'leaves',hint:'Accord du verbe avec le sujet.',explanation:'If she leaves early...'},
...
exercises.countableUncountable.push(
  // __ L1 audit additions __
  {id:'cu_sw_01',type:'fill-blank',diffLevel:1,instruction:'Completez avec much ou many.',template:'How ___ students are in the class?',answer:'many',hint:'students = denombrables.',explanation:'How many students? - denombrables.'},
  {id:'cu_sw_02',type:'fill-blank',diffLevel:1,instruction:'Completez avec much ou many.',template:'How ___ water do you drink every day?',answer:'much',hint:'water = indenombrable.',explanation:'How much water? - indenombrables.'},
  {id:'cu_sw_03',type:'fill-blank',diffLevel:1,instruction:'Completez avec much ou many.',template:'How ___ books did you read last year?',answer:'many',hint:'books = denombrables.',explanation:'How many books? - denombrables.'},
  {id:'cu_sw_04',type:'fill-blank',diffLevel:1,instruction:'Completez avec much ou many.',template:'How ___ time do we have?',answer:'much',hint:'time = indenombrable.',explanation:'How much time? - indenombrable.'},
  {id:'cu_sw_05',type:'fill-blank',diffLevel:1,instruction:'Completez avec much ou many.',template:'How ___ people live in your town?',answer:'many',hint:'people = pluriel.',explanation:'How many people? - many.'},
  {id:'cu_sw_06',type:'fill-blank',diffLevel:1,instruction:'Completez avec much ou many.',template:'How ___ coffee do you drink a day?',answer:'much',hint:'coffee = indenombrable.',explanation:'How much coffee? - much.'},
  {id:'cu_sw_07',type:'fill-blank',diffLevel:1,instruction:'Completez avec much ou many.',template:'How ___ children does she have?',answer:'many',hint:'children = denombrables.',explanation:'How many children? - many.'},
...
exercises.futureContinuous.push(
  // ── L1 single-word fill-blank (audit) ──
  {id:'fc_sw_01',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le verbe -ing manquant.',template:'I will be ___ at 8pm tonight.',answer:'sleeping',hint:"Forme en -ing (présent continu).",explanation:'"I will be sleeping."'},
  {id:'fc_sw_02',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le verbe -ing manquant.',template:'She will be ___ all day tomorrow.',answer:'working',hint:"Forme en -ing (présent continu).",explanation:'"She will be working."'},
  {id:'fc_sw_03',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le verbe -ing manquant.',template:'They will be ___ football this time tomorrow.',answer:'playing',hint:"Forme en -ing (présent continu).",explanation:'"They will be playing football."'},
  {id:'fc_sw_04',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le verbe -ing manquant.',template:'He will be ___ TV when you arrive.',answer:'watching',hint:"Forme en -ing (présent continu).",explanation:'"He will be watching TV."'},
  {id:'fc_sw_05',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le verbe -ing manquant.',template:'I will be ___ for you at the station.',answer:'waiting',hint:"Forme en -ing (présent continu).",explanation:'"I will be waiting for you."'},
  {id:'fc_sw_06',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le verbe -ing manquant.',template:'We will be ___ English next year.',answer:'studying',hint:"Forme en -ing (présent continu).",alternatives:['learning'],explanation:'"We will be studying English."'},
  {id:'fc_sw_07',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le verbe -ing manquant.',template:'It will be ___ when we arrive.',answer:'raining',hint:"Forme en -ing (présent continu).",explanation:'"It will be raining."'},
  {id:'fc_sw_08',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le verbe -ing manquant.',template:'She will be ___ dinner when you get home.',answer:'cooking',hint:"Forme en -ing (présent continu).",alternatives:['making'],explanation:'"She will be cooking dinner."'},
  {id:'fc_sw_09',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le verbe -ing manquant.',template:'They will be ___ their exams this time next week.',answer:'taking',hint:"Forme en -ing (présent continu).",explanation:'"They will be taking their exams."'},
  {id:'fc_sw_10',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le verbe -ing manquant.',template:'He will be ___ a letter when you call.',answer:'writing',hint:"Forme en -ing (présent continu).",explanation:'"He will be writing a letter."'},
...
exercises.futurePerfect.push(
  // ── L1 single-word fill-blank (audit) ──
  {id:'fp_sw_01',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon participe passé.',template:'By Monday, I will have ___ my homework.',answer:'finished',hint:"Past simple régulier (-ed).",explanation:'"I will have finished my homework."'},
  {id:'fp_sw_02',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon participe passé.',template:'She will have ___ by the time you arrive.',answer:'left',hint:"Forme correcte du verbe.",explanation:'"She will have left."'},
  {id:'fp_sw_03',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon participe passé.',template:'They will have ___ the book by Friday.',answer:'read',hint:"Forme correcte du verbe.",explanation:'"They will have read the book."'},
  {id:'fp_sw_04',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon participe passé.',template:'He will have ___ the work by noon.',answer:'done',hint:"Forme correcte du verbe.",explanation:'"He will have done the work."'},
  {id:'fp_sw_05',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon participe passé.',template:'We will have ___ dinner before the film starts.',answer:'eaten',hint:"Forme correcte du verbe.",explanation:'"We will have eaten dinner."'},
  {id:'fp_sw_06',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon participe passé.',template:'She will have ___ all her money by then.',answer:'spent',hint:"Forme correcte du verbe.",explanation:'"She will have spent all her money."'},
  {id:'fp_sw_07',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon participe passé.',template:'They will have ___ home before midnight.',answer:'arrived',hint:"Past simple régulier (-ed).",explanation:'"They will have arrived home."'},
  {id:'fp_sw_08',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon participe passé.',template:'I will have ___ this book by tomorrow.',answer:'written',hint:"Forme correcte du verbe.",explanation:'"I will have written this book."'},
  {id:'fp_sw_09',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon participe passé.',template:'He will have ___ three cups of coffee by lunchtime.',answer:'drunk',hint:"Forme correcte du verbe.",alternatives:['had'],explanation:'"He will have drunk three cups of coffee."'},
  {id:'fp_sw_10',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon participe passé.',template:'We will have ___ 100 lessons by the end of the year.',answer:'completed',hint:"Past simple régulier (-ed).",alternatives:['finished'],explanation:'"We will have completed 100 lessons."'},
...
exercises.pastContinuous.push(
  // ── L1 single-word fill-blank (audit) ──
  {id:'pc_sw_01',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le verbe -ing manquant.',template:'She was ___ a book when I arrived.',answer:'reading',hint:"Forme en -ing (présent continu).",explanation:'"She was reading."'},
  {id:'pc_sw_02',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le verbe -ing manquant.',template:'They were ___ football in the park.',answer:'playing',hint:"Forme en -ing (présent continu).",explanation:'"They were playing football."'},
  {id:'pc_sw_03',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le verbe -ing manquant.',template:'He was ___ TV all evening.',answer:'watching',hint:"Forme en -ing (présent continu).",explanation:'"He was watching TV."'},
  {id:'pc_sw_04',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le verbe -ing manquant.',template:'I was ___ a letter to my sister.',answer:'writing',hint:"Forme en -ing (présent continu).",explanation:'"I was writing a letter."'},
  {id:'pc_sw_05',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le verbe -ing manquant.',template:'It was ___ when we left the house.',answer:'raining',hint:"Forme en -ing (présent continu).",explanation:'"It was raining."'},
  {id:'pc_sw_06',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le verbe -ing manquant.',template:'She was ___ to music in her room.',answer:'listening',hint:"Forme en -ing (présent continu).",explanation:'"She was listening to music."'},
  {id:'pc_sw_07',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le verbe -ing manquant.',template:'We were ___ dinner at 7pm.',answer:'eating',hint:"Forme en -ing (présent continu).",explanation:'"We were eating dinner."'},
  {id:'pc_sw_08',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le verbe -ing manquant.',template:'The baby was ___ peacefully.',answer:'sleeping',hint:"Forme en -ing (présent continu).",explanation:'"The baby was sleeping."'},
  {id:'pc_sw_09',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le verbe -ing manquant.',template:'He was ___ in the garden when it started to rain.',answer:'working',hint:"Forme en -ing (présent continu).",explanation:'"He was working in the garden."'},
  {id:'pc_sw_10',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le verbe -ing manquant.',template:'They were ___ for the bus when I saw them.',answer:'waiting',hint:"Forme en -ing (présent continu).",explanation:'"They were waiting for the bus."'},
...
exercises.phrasalVerbs.push(
  // ── L1 single-word fill-blank (audit) ──
  {id:'phv_sw_01',type:'fill-blank',diffLevel:1,instruction:'Complétez avec la bonne particule.',template:'Please turn ___ the TV before you go to bed.',answer:'off',hint:'Quelle particule complète ce verbe à particule ?',explanation:'"Turn off" = to switch off.'},
  {id:'phv_sw_02',type:'fill-blank',diffLevel:1,instruction:'Complétez avec la bonne particule.',template:'She gave ___ her old clothes to charity.',answer:'away',hint:'Quelle particule complète ce verbe à particule ?',explanation:'"Give away" = to donate.'},
  {id:'phv_sw_03',type:'fill-blank',diffLevel:1,instruction:'Complétez avec la bonne particule.',template:'Pick ___ your toys before dinner!',answer:'up',hint:'Quelle particule complète ce verbe à particule ?',explanation:'"Pick up" = to collect.'},
  {id:'phv_sw_04',type:'fill-blank',diffLevel:1,instruction:'Complétez avec la bonne particule.',template:'She gave ___ smoking last year.',answer:'up',hint:'Quelle particule complète ce verbe à particule ?',explanation:'"Give up" = to stop doing something.'},
  {id:'phv_sw_05',type:'fill-blank',diffLevel:1,instruction:'Complétez avec la bonne particule.',template:'He turned ___ our offer.',answer:'down',hint:'Quelle particule complète ce verbe à particule ?',explanation:'"Turn down" = to refuse.'},
  {id:'phv_sw_06',type:'fill-blank',diffLevel:1,instruction:'Complétez avec la bonne particule.',template:'Look ___ for cars when you cross the road.',answer:'out',hint:'Quelle particule complète ce verbe à particule ?',explanation:'"Look out!" = Be careful!'},
  {id:'phv_sw_07',type:'fill-blank',diffLevel:1,instruction:'Complétez avec la bonne particule.',template:'I need to look ___ this word in the dictionary.',answer:'up',hint:'Quelle particule complète ce verbe à particule ?',explanation:'"Look up" = to search for information.'},
  {id:'phv_sw_08',type:'fill-blank',diffLevel:1,instruction:'Complétez avec la bonne particule.',template:'The fire went ___ after the rain.',answer:'out',hint:'Quelle particule complète ce verbe à particule ?',explanation:'"Go out" = to stop burning.'},
  {id:'phv_sw_09',type:'fill-blank',diffLevel:1,instruction:'Complétez avec la bonne particule.',template:'Can you turn ___ the music? It is too quiet.',answer:'up',hint:'Quelle particule complète ce verbe à particule ?',explanation:'"Turn up" = to increase the volume.'},
  {id:'phv_sw_10',type:'fill-blank',diffLevel:1,instruction:'Complétez avec la bonne particule.',template:'She came ___ with a great idea.',answer:'up',hint:'Quelle particule complète ce verbe à particule ?',explanation:'"Come up with" = to think of an idea.'},
...
exercises.pastPerfect.push(
  // ── L1 single-word fill-blank (audit) ──
  {id:'ppt_sw_01',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon participe passé.',template:'She had already ___ before I arrived.',answer:'left',hint:"Forme correcte du verbe.",explanation:'"She had already left."'},
  {id:'ppt_sw_02',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon participe passé.',template:'They had ___ that film before.',answer:'seen',hint:"Forme correcte du verbe.",explanation:'"They had seen the film."'},
  {id:'ppt_sw_03',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon participe passé.',template:'I had already ___ by the time he called.',answer:'eaten',hint:"Forme correcte du verbe.",explanation:'"I had already eaten."'},
  {id:'ppt_sw_04',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon participe passé.',template:'She had never ___ sushi before.',answer:'tried',hint:"Past simple régulier (-ed).",explanation:'"She had never tried sushi."'},
  {id:'ppt_sw_05',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon participe passé.',template:'They had ___ home before the storm started.',answer:'gone',hint:"Forme correcte du verbe.",explanation:'"They had gone home."'},
  {id:'ppt_sw_06',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon participe passé.',template:'I had never ___ him before that day.',answer:'met',hint:"Forme correcte du verbe.",explanation:'"I had never met him."'},
  {id:'ppt_sw_07',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon participe passé.',template:'She had already ___ the letter.',answer:'read',hint:"Forme correcte du verbe.",explanation:'"She had already read the letter."'},
  {id:'ppt_sw_08',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon participe passé.',template:'He had ___ his homework before dinner.',answer:'done',hint:"Forme correcte du verbe.",explanation:'"He had done his homework."'},
  {id:'ppt_sw_09',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon participe passé.',template:'They had ___ together for ten years.',answer:'worked',hint:"Past simple régulier (-ed).",explanation:'"They had worked together."'},
  {id:'ppt_sw_10',type:'fill-blank',diffLevel:1,instruction:'Complétez avec le bon participe passé.',template:'She had ___ the door before leaving.',answer:'closed',hint:"Past simple régulier (-ed).",explanation:'"She had closed the door."'},
...
exercises.tenseChooser.push(
  ...
  // ── L1 single-word fill-blank (added by audit) ──
  {id:'tc_sw_01',type:'fill-blank',diffLevel:1,instruction:'Complétez avec la bonne forme du verbe.',template:'She ___ to school every day.',answer:'goes',hint:'Pense à la terminaison -s/-es à la 3ème personne.',explanation:'"She goes" = Present Simple, habitude.'},
  {id:'tc_sw_02',type:'fill-blank',diffLevel:1,instruction:'Complétez avec la bonne forme du verbe.',template:'He ___ sleeping right now.',answer:'is',hint:'Action en cours : quel temps ?',explanation:'"He is sleeping" = Present Continuous.'},
  {id:'tc_sw_03',type:'fill-blank',diffLevel:1,instruction:'Complétez avec la bonne forme du verbe.',template:'They ___ finished their homework already.',answer:'have',hint:'Action récente/résultat : quel temps ?',explanation:'"They have finished" = Present Perfect.'},
  ...
  {id:'tc_sw_07',type:'fill-blank',diffLevel:1,instruction:'Complétez avec la bonne forme du verbe.',template:'She ___ cooking when I arrived.',answer:'was',hint:'Action en cours dans le passé : quel temps ?',explanation:'"She was cooking" = Past Continuous.'},
...
exercises.usedTo = [
  // ── L1 single-word fill-blank (audit) ──
  {id:'ut_sw_01',type:'fill-blank',diffLevel:1,instruction:'Complétez avec used ou use.',template:'She ___ to live in Paris.',answer:'used',hint:'Habitude passée : forme affirmative ou base après l\'auxiliaire ?',explanation:'"She used to live in Paris."'},
  {id:'ut_sw_02',type:'fill-blank',diffLevel:1,instruction:'Complétez avec used ou use.',template:'Did you ___ to play football?',answer:'use',hint:'Habitude passée : forme affirmative ou base après l\'auxiliaire ?',explanation:'"Did you use to play?"'},
  {id:'ut_sw_03',type:'fill-blank',diffLevel:1,instruction:'Complétez avec used ou use.',template:'He ___ to wake up very early.',answer:'used',hint:'Habitude passée : forme affirmative ou base après l\'auxiliaire ?',explanation:'"He used to wake up early."'},
  {id:'ut_sw_04',type:'fill-blank',diffLevel:1,instruction:'Complétez avec used ou use.',template:'They ___ to walk to school every day.',answer:'used',hint:'Habitude passée : forme affirmative ou base après l\'auxiliaire ?',explanation:'"They used to walk to school."'},
  {id:'ut_sw_05',type:'fill-blank',diffLevel:1,instruction:'Complétez avec used ou use.',template:'I ___ to love swimming as a child.',answer:'used',hint:'Habitude passée : forme affirmative ou base après l\'auxiliaire ?',explanation:'"I used to love swimming."'},
  {id:'ut_sw_06',type:'fill-blank',diffLevel:1,instruction:'Complétez avec used ou use.',template:'She ___ to be very shy.',answer:'used',hint:'Habitude passée : forme affirmative ou base après l\'auxiliaire ?',explanation:'"She used to be very shy."'},
  {id:'ut_sw_07',type:'fill-blank',diffLevel:1,instruction:'Complétez avec used ou use.',template:'Did he ___ to live here?',answer:'use',hint:'Habitude passée : forme affirmative ou base après l\'auxiliaire ?',explanation:'"Did he use to live here?"'},
  {id:'ut_sw_08',type:'fill-blank',diffLevel:1,instruction:'Complétez avec used ou use.',template:'We ___ to eat together every Sunday.',answer:'used',hint:'Habitude passée : forme affirmative ou base après l\'auxiliaire ?',explanation:'"We used to eat together."'},
  {id:'ut_sw_09',type:'fill-blank',diffLevel:1,instruction:'Complétez avec used ou use.',template:'She did not ___ to like vegetables.',answer:'use',hint:'Habitude passée : forme affirmative ou base après l\'auxiliaire ?',explanation:'"She did not use to like vegetables."'},
  {id:'ut_sw_10',type:'fill-blank',diffLevel:1,instruction:'Complétez avec used ou use.',template:'He ___ to play the piano every evening.',answer:'used',hint:'Habitude passée : forme affirmative ou base après l\'auxiliaire ?',explanation:'"He used to play the piano."'},
...
exercises.goingTo = [
  // ── L1 single-word fill-blank (audit) ──
  {id:'gt_sw_01',type:'fill-blank',diffLevel:1,instruction:'Complétez avec is, am ou are.',template:'She ___ going to cook dinner tonight.',answer:'is',hint:'She = singulier.',explanation:'"She is going to cook dinner."'},
  {id:'gt_sw_02',type:'fill-blank',diffLevel:1,instruction:'Complétez avec is, am ou are.',template:'They ___ going to study this weekend.',answer:'are',hint:'They = pluriel.',explanation:'"They are going to study."'},
  {id:'gt_sw_03',type:'fill-blank',diffLevel:1,instruction:'Complétez avec is, am ou are.',template:'I ___ going to help you with that.',answer:'am',hint:'Accord sujet–verbe.',explanation:'"I am going to help you."'},
  {id:'gt_sw_04',type:'fill-blank',diffLevel:1,instruction:'Complétez avec is, am ou are.',template:'He ___ going to call you later.',answer:'is',hint:'He = singulier.',explanation:'"He is going to call you."'},
  {id:'gt_sw_05',type:'fill-blank',diffLevel:1,instruction:'Complétez avec is, am ou are.',template:'We ___ going to win this match.',answer:'are',hint:'We = pluriel.',explanation:'"We are going to win."'},
  {id:'gt_sw_06',type:'fill-blank',diffLevel:1,instruction:'Complétez avec is, am ou are.',template:'It ___ going to rain this afternoon.',answer:'is',hint:'Accord sujet–verbe.',explanation:'"It is going to rain."'},
  ...
  {id:'gt_sw_10',type:'fill-blank',diffLevel:1,instruction:'Complétez avec is, am ou are.',template:'You ___ going to love this film!',answer:'are',hint:'Accord sujet–verbe.',explanation:'"You are going to love this film."'},
