...
exercises.pastPerfect.push(
  // Level 1 (+15)
  {id:'ppt_1_01',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'By the time I arrived, she ___ already left.',options:['had','have','was','did'],answer:'had',hint:'Past simple de "be".',explanation:'"Had left" = action avant une autre action passée.'},
  {id:'ppt_1_02',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'He ___ never eaten sushi before that day.',options:['had','have','was','did'],answer:'had',hint:'Plus-que-parfait : auxiliaire + participe passé.',explanation:'"Had never eaten" avant ce moment.'},
  ...
  {id:'ppt_1_04',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'We ___ just started when it began to rain.',options:['had','have','was','were'],answer:'had',hint:'Plus-que-parfait : auxiliaire + participe passé.',explanation:'"Had just started."'},
  ...
  {id:'ppt_1_06',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'___ you visited Paris before 2020?',options:['Had','Have','Did','Were'],answer:'Had',hint:'Question au plus-que-parfait : structure interrogative.',explanation:'"Had you visited...?" = question past perfect.'},
...
exercises.conditionals.push(
  ...
  {id:'cond_1_03',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'If I were rich, I ___ travel the world.',options:['will','would','should','could'],answer:'would',hint:'situation irréelle.',explanation:'Conditionnel 2 : If + past, would + infinitif.'},
  ...
  {id:'cond_1_05',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'If I had known, I ___ told you.',options:['would have','will have','would','had'],answer:'would have',hint:'Past simple.',explanation:'Conditionnel 3 : would have + participe.'},
...
exercises.passiveVoice.push(
  // Level 1 (+15)
  {id:'pv_1_01',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'The book ___ written by Shakespeare.',options:['was','is','were','be'],answer:'was',hint:'Past simple.',explanation:'Passif passé singulier : was + participe.'},
  {id:'pv_1_02',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'The letters ___ sent every morning.',options:['is','are','was','were'],answer:'are',hint:'pluriel présent.',explanation:'Passif présent pluriel : are + participe.'},
  {id:'pv_1_03',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'The car ___ stolen last night.',options:['is','are','was','were'],answer:'was',hint:'Past simple.',explanation:'Passif passé : was + participe.'},
  {id:'pv_1_04',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'English ___ spoken all over the world.',options:['is','are','was','were'],answer:'is',hint:'présent singulier.',explanation:'Passif présent singulier : is + participe.'},
  {id:'pv_1_05',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'The cakes ___ made by my mother.',options:['was','were','is','are'],answer:'were',hint:'Past simple.',explanation:'Passif passé pluriel : were + participe.'},
  {id:'pv_1_06',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'This photo ___ taken in 2010.',options:['is','are','was','were'],answer:'was',hint:'Past simple.',explanation:'Passif passé singulier.'},
...
exercises.reportedSpeech.push(
  // Level 1 (+15)
  {id:'rs_1_01',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'"I am tired." → He said he ___ tired.',options:['was','is','were','be'],answer:'was',hint:'Discours indirect : recule le temps du verbe.',explanation:'"Am" devient "was" au discours indirect.'},
  {id:'rs_1_02',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'"I will help." → She said she ___ help.',options:['would','will','could','should'],answer:'would',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"Will" devient "would" au discours indirect.'},
  {id:'rs_1_03',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'"I can swim." → She said she ___ swim.',options:['could','can','would','should'],answer:'could',hint:'Forme correcte du verbe (vérifie le temps).',explanation:'"Can" devient "could" au discours indirect.'},
...
exercises.futureContinuous.push(
  // Level 1 (+15)
  {id:'fc_1_01',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'This time tomorrow, I ___ flying to Paris.',options:['will be','am','would be','shall'],answer:'will be',hint:'Futur continu : auxiliaire + be + -ing.',explanation:'"Will be flying" — futur continu.'},
  {id:'fc_1_02',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'She ___ working all day tomorrow.',options:['will be','am being','would be','is'],answer:'will be',hint:'Futur continu : auxiliaire + be + -ing.',explanation:'"Will be working."'},
  {id:'fc_1_03',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'___ you be coming to the party?',options:['Will','Would','Shall','Are'],answer:'Will',hint:'Question au futur continu : structure interrogative.',explanation:'"Will you be coming...?"'},
  ...
  {id:'fc_1_05',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'He ___ sleeping by the time you arrive.',options:['will be','is','would','shall'],answer:'will be',hint:'Futur continu : auxiliaire + be + -ing.',explanation:'"Will be sleeping."'},
  {id:'fc_1_06',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'They ___ travelling next week.',options:['will be','are','were','would'],answer:'will be',hint:'action future en cours.',explanation:'"Will be travelling."'},
...
exercises.futurePerfect.push(
  // Level 1 (+15)
  {id:'fp_1_01',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'By next year, I ___ finished my studies.',options:['will have','have','would have','shall'],answer:'will have',hint:'avant un moment futur.',explanation:'"Will have finished" — futur antérieur.'},
  {id:'fp_1_02',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'By 5pm, she ___ finished the report.',options:['will have','has','would','shall'],answer:'will have',hint:'before a future time.',explanation:'"Will have finished by 5pm."'},
  {id:'fp_1_03',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'By the time you arrive, I ___ eaten.',options:['will have','have','would have','shall'],answer:'will have',hint:'avant un futur.',explanation:'"Will have eaten by the time you arrive."'},
  {id:'fp_1_04',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'They ___ built the school by 2026.',options:['will have','have','would have','had'],answer:'will have',hint:'by + futur.',explanation:'"Will have built by 2026."'},
  {id:'fp_1_05',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'He ___ worked here for 20 years by December.',options:['will have','has','would have','had'],answer:'will have',hint:'by + futur + durée.',explanation:'"Will have worked for 20 years."'},
  {id:'fp_1_06',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne réponse.',question:'___ you finished by tomorrow?',options:['Will you have','Have you','Would you have','Did you'],answer:'Will you have',hint:'Question au futur antérieur : structure interrogative.',explanation:'"Will you have finished by tomorrow?"'},
...
exercises.futureSimple.push(
  ...
  {id:'fts_1_03',type:'multiple-choice',diffLevel:1,instruction:'Choisissez la bonne forme.',question:'___ you help me?',options:['Will','Would','Shall','Are'],answer:'Will',hint:'Quel auxiliaire pour le futur ?',explanation:'"Will you help me?"'},
