...
exercises.reportedSpeech.push(
  ...
  {id:'rs_2_03',type:'translate',diffLevel:2,instruction:'Traduisez en anglais.',french:'"Je peux nager," dit-il.',answer:'He said he could swim.',hint:'can → could',explanation:'"Can swim" → "could swim".', acceptedAnswers: ['He said that he could swim.'] },
...
exercises.connectors.push(
  ...
  {id:'con_1_14',type:'word-order',diffLevel:1,instruction:'Mettez dans le bon ordre.',words:['raining','it','go','Although','out','was','we','went'],answer:'Although it was raining we went out.',hint:'concession → although',explanation:'"Although it was raining..."', acceptedAnswers: ['Even though it was raining we went out.', 'Though it was raining we went out.'] },
  ...
  {id:'con_2_05',type:'translate',diffLevel:2,instruction:'Traduisez en anglais.',french:'Il parle anglais ; cependant, il fait beaucoup de fautes.',answer:'He speaks English; however, he makes many mistakes.',hint:'cependant → however',explanation:'"However" — contraste formel.', acceptedAnswers: ['He speaks English but he makes many mistakes.', 'He speaks English, but he makes many mistakes.', 'He speaks English. However, he makes many mistakes.', 'He speaks English. However he makes many mistakes.'] },
  ...
  {id:'con_2_13',type:'word-order',diffLevel:2,instruction:'Mettez dans le bon ordre.',words:['tired','was','she','Although','well','worked','she'],answer:'Although she was tired she worked well.',hint:'concession → although',explanation:'"Although she was tired."', acceptedAnswers: ['Even though she was tired she worked well.', 'Though she was tired she worked well.'] },
...
exercises.phrasalVerbs.push(
  ...
  {id:'phv_2_04',type:'translate',diffLevel:2,instruction:'Traduisez en anglais.',french:"Éteins la lumière en sortant.",answer:'Turn off the light when you leave.',hint:'éteindre → turn off',explanation:'"Turn off the light."', acceptedAnswers: ['Switch off the light when you leave.', 'Turn the light off when you leave.', 'Switch the light off when you leave.'] },
  {id:'phv_2_05',type:'translate',diffLevel:2,instruction:'Traduisez en anglais.',french:"J'ai découvert la vérité.",answer:'I found out the truth.',hint:'découvrir → find out',explanation:'"Found out the truth."', acceptedAnswers: ['I discovered the truth.', 'I learned the truth.'] },
